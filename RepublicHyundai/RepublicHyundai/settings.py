"""
Django settings for RepublicHyundai project.
...
SECRET_KEY = 'b_wj*xd0kel+n+q985$w_^do5r5#cabfri$=#ni_!smnm_66(7'
...
ROOT_URLCONF = 'RepublicHyundai.urls'
...
WSGI_APPLICATION = 'RepublicHyundai.wsgi.application'
